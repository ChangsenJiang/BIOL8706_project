...
species_list = ["Promerops_cafer", "Cnemophilus_loriae", "Menura_novaehollandiae", "Serilophus_lunatus", "Acanthisitta_chloris", "Chunga_burmeisteri", "Urocolius_indicus", "Ciconia_maguari","Phaethon_lepturus", "Nyctiprogne_leucopyga", "Psophia_crepitans", "Opisthocomus_hoazin", "Crotophaga_sulcirostris", "Lophotis_ruficrista", "Tauraco_erythrolophus", "Columbina_picui","Mesitornis_unicolor", "Podiceps_cristatus", "Podilymbus_podiceps", "Phoenicopterus_ruber", "Callipepla_squamata", "Chauna_torquata", "Alectura_lathami", "Gallus_gallus"]
